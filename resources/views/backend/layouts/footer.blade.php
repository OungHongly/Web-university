...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>UNIS</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">SS6.7</a>
    </div>
</footer><!-- End Footer -->
...
<script src="{{ url('backend/vendor/chart.js/chart.umd.js') }}"></script>
