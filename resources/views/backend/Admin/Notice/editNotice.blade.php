<!-- edit Notice form-->
@csrf
<form class="row g-3" action="/notice/edit/">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="date" class="form-control" id="txtDate" value="{{ $notices->date}}">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" style="height: 100px" id="txtEvent" value="{{ $notices->event}}"></textarea>
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" name="hidden_id" value="{{ $notices->id }}"/>
            <button type="submit" class="btn btn-primary"><a href="{{route(edit_validate)}}"> Edit Notice</button>
        </div>
    </div>
</form>
