                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button button type="button" class="btn btn-primary"
                                                                    ...
                                                                    data-bs-target="#edit-{{ $cou->course_id }}">
                                                                    Edit
                                                                </button>

                                                                <div class="modal fade" id="edit-{{ $cou->course_id }}"
                                                                    tabindex="1">
                                                                ...
                                                                <button button type="button" class="btn btn-danger"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#delete-{{ $cou->course_id }}">
                                                                    Delete
                                                                </button>

                                                                <div class="modal fade" id="delete-{{ $cou->course_id }}"
                                                                    tabindex="1">
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <a href="/course/delete/{{ $cou->course_id }}">
